...
private let DEP_SER = "https://65dc45f8e7edadead7eb7a21.mockapi.io/"
private let DEV_SER = "https://65dc45f8e7edadead7eb7a21.mockapi.io/"
...
class AFHttp{
    ...
    static let API_POST_LIST = "api/post"
    static let API_POST_SINGLE = "api/post/" //id
    static let API_POST_CREATE = "api/post"
    static let API_POST_UPDATE = "api/post/" //id
    static let API_POST_DELETE = "api/post/" //id
